...
if __name__ == "__main__":
    ...
    for _ in range(10):
        ...
        #G = graph.new_input(dims=(1, 4096), dtype=mirage_dtype)
    ...
    input_tensors = [
        torch.randn(1, 1, 4096, dtype=torch_dtype, device='cuda:0'),
        #torch.randn(1, 4096, dtype=torch_dtype, device='cuda:0'),
        torch.randn(4096, 16384, dtype=torch_dtype, device='cuda:0'),
    ]
